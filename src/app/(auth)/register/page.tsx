                ...
                <div className="w-full max-w-md space-y-4 px-4">
                    <div className="text-center">
                        ...
                        <p className="mt-2 text-sm text-muted-foreground">
                            Already have an account? <Link href={ROUTES.LOGIN} className="font-bold underline">sign
                            in</Link>
                        </p>
                    </div>
                        ...
                        <form className="mt-8 space-y-6" onSubmit={form.handleSubmit(onSubmit)} >
                            ...
                            <FormField control={form.control} name="name" render={({ field }) => (
                                    <FormItem>
                                        ...
                                        <FormControl>
                                            <Input {...field} disabled={isLoading} placeholder="name" type="text" />
                                        </FormControl>
                                        <FormMessage />
                                    </FormItem>
                                )} />
                ...
                <div className="h-full flex flex-col items-center justify-center text-white px-12 ">
                    ...
                    <h2 className="text-3xl font-bold mb-6">Create Your Account</h2>
                        <p className="text-lg text-indigo-200 mb-8">
                            Join us and explore endless possibilities with a secure and personalized experience.
                        </p>
