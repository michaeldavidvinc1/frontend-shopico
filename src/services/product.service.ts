...
export const {useCreateProductMutation, useGetAllProductByStoreQuery, useGetSingleProductQuery, useUpdateProductMutation, useDeleteProductMutation} = productApi